...
use sphincs_c13_signer::{hash, keygen, sphincs, u256_from_be, verifier};
use sphincs_c13_signer::params::*;

use std::io::{self, Read, Write};
use std::process::ExitCode;

const PARAM_SET_NAME: &str = "C13";
...
const SIG_BYTES: usize = SIG_SIZE; // 3688
