...
structure Config where
  stateDir : System.FilePath := ".leancli/keystore/tpm2"
...
def listSepoliaKeys (stateDir : System.FilePath := ".leancli/keystore/tpm2") :
    IO (List String) := do
