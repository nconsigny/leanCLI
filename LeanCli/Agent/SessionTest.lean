...
namespace LeanCli.Agent.SessionTest

open LeanCli.Agent
open LeanCli.Agent.Session
...
private def tmpDbPath : IO String := do
  ...
  pure s!"{base}/leancli-session-test-{pid}.sqlite"
...
end LeanCli.Agent.SessionTest

def main : IO UInt32 := LeanCli.Agent.SessionTest.main
