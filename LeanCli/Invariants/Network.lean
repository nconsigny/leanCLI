...
namespace LeanCli.Invariants.Network
...
over both env forms; the namespaced env var (`LEANCLI_RPC_URL_<UPPER>`)
...
form shadows the leanCLI-namespaced one. -/

open LeanCli.Daemon.Config in
...
end LeanCli.Invariants.Network
