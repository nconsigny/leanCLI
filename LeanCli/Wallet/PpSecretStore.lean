...
the leancli-bridge sidecar uses as the Privacy-Pools spending secret.
...
namespace LeanCli.Wallet.PpSecretStore
...
def storeDir : IO System.FilePath := do
  pure ((← LeanCli.Wallet.EoaStore.dataHome) / "leancli" / "pp")
...
end LeanCli.Wallet.PpSecretStore
