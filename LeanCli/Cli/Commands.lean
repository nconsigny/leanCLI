...
def zshAccountOverride : String :=
  String.intercalate "\n" [
    ...
    "  _leancli_complete",
    "}",
    "compdef _leancli_complete_zsh leancli leancli",
    ""
  ]

def zshCompletion : String :=
  "#compdef leancli leancli\nautoload -U bashcompinit && bashcompinit\n" ++ bashCompletion ++ "\n" ++ zshAccountOverride
...
def fishCompletion : String :=
  String.intercalate "\n" [
    ...
    "",
    "# --- top-level verbs ---",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a help          -d 'Show usage'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a version       -d 'Print version'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a doctor        -d 'Implementation/check status'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a policy        -d 'Show internal policy reference'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a network       -d 'Network/RPC configuration'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a wallet        -d 'Wallet management'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a shield        -d 'Privacy-Pools deposit / status'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a unshield      -d 'Privacy-Pools withdrawal'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a daemon        -d 'Daemon control'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a balance       -d 'Read ETH balance of one address'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a balances      -d 'Per-token balances for one address'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a list          -d 'Tree view of EOA + TPM/R1 wallets'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a send          -d 'Send ETH'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a from          -d 'Per-wallet send: from <wallet> send …'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a chain         -d 'Low-level chain utilities'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a debug         -d 'Debug / simulation'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a resolve       -d 'Resolve ENS name to address'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a tui           -d 'Open the interactive TUI'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a ui            -d 'Alias for tui'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a install       -d 'Rebuild + relink ~/.leancli/bin'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a update        -d 'git pull + rebuild + relink'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a uninstall     -d 'Remove ~/.leancli/bin symlinks'",
    "complete -c leancli -c leancli -n __fish_use_subcommand -a completion    -d 'Print a shell completion script'",
    "",
    "# --- wallet ---",
    ...
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from wallet; and not __fish_seen_subcommand_from create import deploy list show address unlock lock delete reveal derive sign-digest sign-message sign-tx sign-typed-data history account use current master enroll' -a \"$__leancli_wallet_verbs\"",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from wallet; and __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from eoa r1' -a 'eoa r1' -d 'Account type'",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from wallet; and __fish_seen_subcommand_from account; and not __fish_seen_subcommand_from add list rm' -a 'add list rm' -d 'Sub-account op'",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from wallet; and __fish_seen_subcommand_from master; and not __fish_seen_subcommand_from init status set-timeout bind-tpm' -a 'init status set-timeout bind-tpm' -d 'Master KEK op'",
    "# Dynamic wallet names for verbs that take a single <name>.",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from wallet; and __fish_seen_subcommand_from show address unlock lock delete reveal derive sign-digest sign-message sign-tx sign-typed-data history deploy use enroll' -a '(__leancli_wallet_names)' -d Wallet",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from wallet; and __fish_seen_subcommand_from account; and __fish_seen_subcommand_from add list rm' -a '(__leancli_wallet_names)' -d Wallet",
    "",
    "# --- send / from / --account ---",
    "complete -c leancli -c leancli -l account -r -d 'Wallet' -n 'not __fish_seen_subcommand_from send' -a '(__leancli_wallet_names)'",
    "complete -c leancli -c leancli -l account -r -d 'Wallet/<index>' -n '__fish_seen_subcommand_from send' -a '(__leancli_account_send_values)'",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from from; and not __fish_seen_subcommand_from send' -a '(__leancli_wallet_names)' -d Wallet",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from from; and __fish_seen_subcommand_from send' -a send",
    "",
    "# --- shield ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from shield; and not __fish_seen_subcommand_from balance reveal import delete' -a 'balance reveal import delete' -d 'PP op'",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from shield; and not __fish_seen_subcommand_from balance reveal import delete' -a '(__leancli_wallet_names)' -d Wallet",
    "",
    "# --- network ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from network; and not __fish_seen_subcommand_from show path set-rpc set-lightclient set-policy unset-rpc set-ens-rpc unset-ens-rpc set-rpc-chain unset-rpc-chain set-chain monitor' -a 'show path set-rpc set-lightclient set-policy unset-rpc set-ens-rpc unset-ens-rpc set-rpc-chain unset-rpc-chain set-chain monitor'",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from network; and __fish_seen_subcommand_from set-policy' -a 'strict tor permissive' -d Policy",
    "",
    "# --- daemon ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from daemon; and not __fish_seen_subcommand_from help start stop restart ping status logs version' -a 'help start stop restart ping status logs version' -d 'Daemon op'",
    "",
    "# --- chain ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from chain; and not __fish_seen_subcommand_from balance nonce token-balance gas-price priority-fee estimate-gas broadcast' -a 'balance nonce token-balance gas-price priority-fee estimate-gas broadcast'",
    "",
    "# --- debug ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from debug; and not __fish_seen_subcommand_from policy-check rpc-check rpc-methods endpoint-check decode' -a 'policy-check rpc-check rpc-methods endpoint-check decode'",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from debug; and __fish_seen_subcommand_from decode' -a erc20",
    "",
    "# --- policy ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from policy; and not __fish_seen_subcommand_from accounts keystore lightclient network privacy security all' -a 'accounts keystore lightclient network privacy security all'",
    "",
    "# --- completion ---",
    "complete -c leancli -c leancli -n '__fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from bash zsh fish' -a 'bash zsh fish' -d Shell",
    ""
  ]
