...
Proofs that `LeanKohaku.Ethereum.IntentEncode.encode` behaves correctly
...
namespace LeanKohaku.Invariants.IntentTrusted

open LeanKohaku.Ethereum.Intent
open LeanKohaku.Ethereum.IntentEncode
...
theorem approve_unlimited_is_max_uint :
    approveAmountToNat .unlimited = LeanKohaku.Ethereum.Erc20.maxUint256 := by
  rfl
...
end LeanKohaku.Invariants.IntentTrusted
