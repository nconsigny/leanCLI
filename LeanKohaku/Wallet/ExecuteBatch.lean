...
* `execute(address,uint256,bytes)`              = `0xb61d27f6`  (single-call entry, already used by `LeanKohaku/Sphincs/Send.lean`)
...
namespace LeanKohaku.Wallet.ExecuteBatch

open LeanKohaku.Swap.UniV3 (encodeAddress encodeUint256 encodeBytes padLeft32)
...
end LeanKohaku.Wallet.ExecuteBatch
