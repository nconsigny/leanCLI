...
the kohaku-bridge sidecar uses as the Railgun spending secret.
...
namespace LeanKohaku.Wallet.RgSecretStore
...
def storeDir : IO System.FilePath := do
  pure ((← LeanKohaku.Wallet.EoaStore.dataHome) / "leankohaku" / "rg")
...
end LeanKohaku.Wallet.RgSecretStore
