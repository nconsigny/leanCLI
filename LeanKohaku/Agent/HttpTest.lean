...
/-!
Compile-time assertions over `LeanKohaku.Agent.Http`'s pure pieces.
...
namespace LeanKohaku.Agent.Http.Test

open LeanKohaku.Agent.Http
...
end LeanKohaku.Agent.Http.Test
