...
`LeanKohaku.Ethereum.TokenRegistry` and are pure / no IO.
...
namespace LeanKohaku.Agent.ToolDefs.Tokens

open LeanKohaku.Agent
open LeanKohaku.Agent.Tools
open LeanKohaku.Encoding.Json
open LeanKohaku.Ethereum.TokenRegistry
...
end LeanKohaku.Agent.ToolDefs.Tokens
