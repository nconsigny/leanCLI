# kohaku-wallet — operating model

## The verified core vs. the agent

leanKohaku has a small, formally-verified core in Lean 4 that owns
...
stated, formalized in `LeanKohaku/Invariants/Nonce.lean`). The agent
