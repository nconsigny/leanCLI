...
**Signature**: `onRemoveFromBatch(uint256 _troveId,uint256 _newTroveColl,uint256 _newTroveDebt,TroveChange _troveChange,address _batchAddress,uint256 _newBatchColl,uint256 _newBatchDebt,uint256 _newAnnualInterestRate)`
...
TODO(curator): operational semantics for `TroveManager.onRemoveFromBatch` — see <https://github.com/liquity/bold/blob/main/README.md>.
