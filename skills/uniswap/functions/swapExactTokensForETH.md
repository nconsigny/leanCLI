...
TODO(curator): operational semantics for `UniswapV2Router02.swapExactTokensForETH` — see <https://docs.uniswap.org/contracts/v2/reference/smart-contracts/router-02>.
