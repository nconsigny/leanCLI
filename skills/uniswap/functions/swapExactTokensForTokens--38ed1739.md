...
- `amountOutMin` (`uint256`): TODO(curator): describe
...
TODO(curator): operational semantics for `UniswapV2Router02.swapExactTokensForTokens` — see <https://docs.uniswap.org/contracts/v2/reference/smart-contracts/router-02>.
