...
**Status:** ✅ proved — `LeanCli/Invariants/Core.lean::no_key_exfiltration`
...
**Status:** ✅ proved — `LeanCli/Invariants/Amount.lean::subChecked_preserves_total`
...
model is in `LeanCli/Invariants/Wallet.lean`: `State`, `Send`, `apply`.
...
**Status:** ✅ proved — `LeanCli/Invariants/Wallet.lean`
...
**Location:** `LeanCli/Invariants/TxWellFormed.lean`
...
`LeanCli/Invariants/Encoding.lean`. Full round-trip blocked on a
non-`partial` decoder.
...
are proved in `LeanCli/Invariants/Encoding.lean` (`hexDigit_*`,
...
**Status:** ✅ proved — `LeanCli/Invariants/Bridge.lean`
...
`LeanCli/Privacy/Bridge.lean`. Will be machine-checked once a
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean`
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean::strictCli_onlyLocalDaemon`
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean::deniedThirdPartyPurposesStrict`
...
namespaced env form `LEANCLI_RPC_URL_<UPPER>` always wins over the generic
`<UPPER>_RPC_URL`. This rules out a stale env value silently overriding
explicit user config or the legacy generic form shadowing the leanCLI-
namespaced one.
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean::pickChainUrl_*`
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean::nonBroadcastMethodsAreReads`
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean::strictConfiguredProviderDenied`
...
**Status:** ✅ proved — `LeanCli/Invariants/Network.lean::torConfiguredProviderOnlyTor`
...
**Status:** ✅ proved — `LeanCli/Invariants/Keystore.lean::acceptedNeverExportsSecrets`
...
**Status:** ✅ proved — `LeanCli/Invariants/Keystore.lean::acceptedRequiresLocalOnly`
...
`LeanCli/Contract/SphincsAccount.lean`.
...
**Status:** ✅ proved — `LeanCli/Invariants/SphincsAccount.lean::applySomeSupportedChainOnly`
...
**Status:** ✅ proved — `LeanCli/Invariants/SphincsAccount.lean::applyRotateOwnerNonZero`
...
**Status:** ✅ proved — `LeanCli/Invariants/SphincsAccount.lean::applyRotateKeysSupersedesOldPq`
...
**Status:** ✅ proved — `LeanCli/Invariants/SphincsAccount.lean::applyRotateOwnerSupersedesOldOwner`
...
**Status:** ✅ proved — `LeanCli/Invariants/Swap.lean::slippageZeroIsIdentity`
...
**Status:** ✅ proved — `LeanCli/Invariants/Swap.lean::balancesCandidates_addressOn_some`
...
**Status:** ✅ proved — `LeanCli/Invariants/AddressOwnership.lean::checkOwned_verified_imp`, `::resolve_verified_witnesses_derivation`
...
`LeanCli/Crypto/Hacl.lean` (bound to HACL\*/RustCrypto), behind
`LeanCli/Crypto/Secp256k1Native.lean`, or as an oracle parameter in an
...
3. Open a module under `LeanCli/Invariants/` if one doesn't exist.
